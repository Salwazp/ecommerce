    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            @if($cart && $cart->items->count() > 0)
                ...
                <h4>Shipping: {{ number_format($shipping, 2) }}</h4>
                <h4>Total: {{ number_format($total, 2) }}</h4>
            @else
                <div class="alert alert-warning">
                    <h4>Your cart is empty!</h4>
                    <p>Looks like you haven't added any products to your cart. Start shopping now!</p>
                    <a href="{{ route('customer.shop') }}" class="btn btn-primary">Browse Products</a>
                </div>
            @endif
