...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset(' asset/admin/assets/css/azzara.min.css') }}/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <link href="{{ asset(' asset/admin/assets/css/azzara.min.css') }}/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="{{ asset(' asset/admin/assets/css/azzara.min.css') }}/css/bootstrap.min.css" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{ asset(' asset/admin/assets/css/azzara.min.css') }}/css/style.css" rel="stylesheet">
    </head>
        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">MarketPlace</h1></a>
    ...
    <!-- Template Javascript -->
    <script src="{{ asset(' asset/admin/assets/css/azzara.min.css') }}/js/main.js"></script>
    </body>
