                                ...
                                <li>
                                    <div class="message-notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            <a href="chat.html">
                                                <div class="notif-img">
                                                    <img src="{{ asset('assets/admin') }}/assets/img/jm_denis.jpg"
                                                        alt="Img Profile">
                                                </div>
                                            ...
                                            <a href="chat.html">
                                                <div class="notif-img">
                                                    <img src="{{ asset('assets/admin') }}/assets/img/chadengle.jpg"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="chat.html">
                                                <div class="notif-img">
                                                    <img src="{{ asset('assets/admin') }}/assets/img/mlane.jpg"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="chat.html">
                                                <div class="notif-img">
                                                    <img src="{{ asset('assets/admin') }}/assets/img/talha.jpg"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                            ...
                            <ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
                                ...
                                <li>
                                    <div class="notif-center">
                                        ...
                                        <a href="#">
                                            <div class="notif-img">
                                                <img src="{{ asset('assets/admin') }}/assets/img/profile2.jpg"
                                                    alt="Img Profile">
                                            </div>
                                            <div class="notif-content">
                                                <span class="block">
                                ...
                                <li>
                                    <div class="user-box">
                                        <div class="avatar-lg"><img
                                                src="{{ asset('assets/admin') }}/assets/img/profile.jpg"
