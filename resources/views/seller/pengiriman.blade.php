                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="kelolaProduk.html">Lihat Produk</a>
                            </li>
                            <li class="separator">
                                <i class="flaticon-right-arrow"></i>
                            </li>
                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="tambahProduk.html">Informasi
                                        Produk</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="informasiPenjualan.html">Informasi Penjualan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="pengiriman.html">Pengiriman</a>
                                </li>
                            </ul>
                        </div><br>
                        <div class="form-group">
                            <label for="basic-url">Berat</label>
                        ...
                        <div class="form-group">
                            <label for="basic-url">Produk Berbahaya</label>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value="">
                                    <span class="form-check-sign">Tidak</span>
                                </label>
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value="">
                                    <span class="form-check-sign">Mengandung Baterai/Cairan/Bahan mudah terbakar</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="basic-url">Ongkos Kirim</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <label for="basic-url">Pre Order</label>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value="">
                        ...
                        <div class="form-group">
                            <label for="pillSelect">Kondisi</label>
