                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="informasiPenjualan.html">Informasi Penjualan</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="form-group form-floating-label">
                            <input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"
                                required="">
                            <label for="inputFloatingLabel" class="placeholder">Stok</label>
                        </div>
                        <div class="form-group">
                            <label for="basic-url">Harga Grosir</label>
                            <div class="input-group mb-3">
