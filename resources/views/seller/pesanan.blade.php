                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="pesananBaru.html">
                                        Pesanan Baru</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="siapdikirim.html">Siap Dikirim</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="dalamPengiriman.html">Dalam Pengiriman</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="pesananSelesai.html">Pesanan Selesai</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="dibatalkan.html">Dibatalkan</a>
                                </li>
                            </ul>
                        </div><br>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Terima semua pesanan</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" ><a href="siapdikirim.html">Save changes</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card mb-4" style="max-width: 100%;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <h5 class="card-title">Mens T-shirt Cotton Base</h5>
                                                <p class="card-text">Blue, Medium<br>Jumlah Barang (2)<br>$44.80
                                                    $12.20 /
                                                    per item</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn-primary me-md-2" type="button">Terima
                                            Pesanan</button>
                                        <!-- <p class="d-inline-flex gap-1">
                                        <button type="button" class="btn" disabled data-bs-toggle="button"><i>Menunggu
                                                Pembayaran Selesai Dilakukan</i></button>
                                    </p> -->
                                ...
                                <div class="card mb-4" style="max-width: 100%;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <h5 class="card-title">Mens T-shirt Cotton Base</h5>
                                                <p class="card-text">Blue, Medium<br>Jumlah Barang (2)<br>$44.80 $12.20
                                                    /
                                                    per item</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn-primary me-md-2" type="button">Terima Pesanan</button>
                                        <!-- <p class="d-inline-flex gap-1">
                                                <button type="button" class="btn" disabled data-bs-toggle="button"><i>Menunggu
                                                        Pembayaran Selesai Dilakukan</i></button>
                                            </p> -->
