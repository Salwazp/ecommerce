                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="tambahProduk.html">Informasi
                                        Produk</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="pengiriman.html">Pengiriman</a>
                                </li>
                        ...
                        <div class="form-group form-floating-label">
                            <input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"
                                required="">
                            <label for="inputFloatingLabel" class="placeholder">Nama Produk</label>
                        </div>
                        <div class="form-group">
                            <label for="pillSelect">Kategori</label>
