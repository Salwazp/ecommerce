                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="pesanan.html">
                                        Pesanan Baru</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="siapdikirim.html">Siap Dikirim</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card mb-4" style="max-width: 100%;">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <div class="col-md-3">
                                            <div class="demo-icon">
                                                <div class="icon-preview"><i class="la flaticon-interface-6"></i></div>
                                                <div class="icon-class"><a href="resi.html">Cetak Resi</a></div>
                                            </div>
                                        </div>
                                        <button class="btn btn-primary me-md-2" type="button">Kirim
                                            Pesanan</button>
                            ...
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card mb-4" style="max-width: 100%;">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        ...
                                        <button class="btn btn-primary me-md-2" type="button">Kirim Pesanan</button>
                                        <!-- <p class="d-inline-flex gap-1">
                                                <button type="button" class="btn" disabled data-bs-toggle="button"><i>Menunggu
                                                        Pembayaran Selesai Dilakukan</i></button>
                                            </p> -->
