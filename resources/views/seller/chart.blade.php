...
<body>
  ...
  -->
    ...
    <!-- JQuery Sparkline -->
    <script src="{{ asset('assets/seller') }}/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>
    <!-- jQuery UI -->
    ...
    <!-- Chart JS -->
    <script src="{{ asset('assets/seller') }}/assets/js/plugin/chart.js/chart.min.js"></script>
    <script>
