  ...
  -->
        ...
        <div class="main-panel">
            ...
            <div class="container-fluid px-4">
                <h3 class="mt-4">Review Pembeli</h3>
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>1.</td>
                                <td>awaa</td>
                                <td><img src="{{ asset('assets/seller') }}/assets/seller') }}/img/new-product/5-small.jpg" alt="" /></td>
                                <td>Kaos About you</td>
                                <td><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                        class="fa fa-star"></i></td>
                                <td>Bahan nya sangat bagus dan nyaman</td>
                            </tr>
                            </tfoot>
                    </table>
                </div>
