...
<body>
		...
		<div class="main-header" data-background-color="purple">
			...
			<div class="logo-header">
				...
				<a href="dashboard.html" class="logo">
					<img src="{{ asset('assets/admin') }}/assets/img/logoazzara.svg" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="{{ asset('assets/admin') }}/assets/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
										<div class="u-text">
											<h4>Hizrian</h4>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="card card-profile card-secondary">
								<div class="card-header" style="background-image: url('{{ asset('assets/admin') }}/assets/img/blogpost.jpg')">
	...
	<!-- Moment JS -->
	<script src="{{ asset('assets/admin') }}/assets/js/plugin/moment/moment.min.js"></script><!-- DateTimePicker -->
	<script src="{{ asset('assets/admin') }}/assets/js/plugin/datepicker/bootstrap-datetimepicker.min.js"></script>
	<!-- Bootstrap Toggle -->
